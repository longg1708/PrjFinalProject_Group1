            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div id="successMessage" class="alert alert-success text-center" style="display: none;">
                        ...
                        <a href="${pageContext.request.contextPath}/home" class="btn btn-primary" id="returnHomeBtn">Return to Home</a>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        checkoutForm.addEventListener('submit', function (event) {
            ...
            fetch('${pageContext.request.contextPath}/clearCart', { method: 'POST' })  
                .then(response => response.text())
                .then(data => console.log('Cart cleared:', data))
                .catch(error => console.error('Error:', error));
        });

        // Keep the success message visible until user clicks "Return to Home"
